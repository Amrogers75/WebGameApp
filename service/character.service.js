    ...
    function characterService() {
        ...
        vm.evilDwelers = [
            ...
            },
            {
                ...
                "moveTwoDmg":  Math.floor(Math.random() * (2-4)),
                //move three
            ...
            },
            {
                ...
                "moveThreeDmg":  Math.floor(Math.random() * (2 - 5)),
                "diffuclty": "1",
            ...
            },
            {
                ...
                "moveOneDmg": Math.floor(Math.random() * (6-8)),
                //move two
                "moveTwo": 'Bruce trys to hug you and says fish are freinds, not food and squishis you to hard',
                "moveTwoDmg":  Math.floor(Math.random() * (5-7)),
                //move three
                "moveThree": 'Bruce smakes you with his tail fin',
                "moveThreeDmg":  Math.floor(Math.random() * (3 - 6)),
                "diffuclty": "1",
            ...
            },
            {
                ...
                "moveTwoDmg":  Math.floor(Math.random() * (6-4)),
                //move three
                "moveThree": 'Mario gravbs his F.U.D.D backpack and blasts you with it',
                "moveThreeDmg":  Math.floor(Math.random() * (4- 5)),
                "diffuclty": "1",
...

      {
              ...
              "moveThreeDmg":  Math.floor(Math.random() * (1 - 11)),
                "diffuclty": "2",
            ...
            },
      {
          ...
          "moveOneDmg": Math.floor(Math.random() * (7-3)),
          //move two
          "moveTwo": 'dora pulls something out of her backpack and smacks you with it ',
          "moveTwoDmg":  Math.floor(Math.random() * (1-9)),
          //move three
...

      {
          ...
          "moveTwoDmg":  Math.floor(Math.random() * (5-7)),
          //move three
          "moveThree": 'yoshi picks up a big green pokadoted egg and throws it at you who knows whats inside',
          "moveThreeDmg":  Math.floor(Math.random() * (2 - 10)),
                "diffuclty": "3",
